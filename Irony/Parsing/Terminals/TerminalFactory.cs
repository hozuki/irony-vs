...
namespace Irony.Parsing {
    ...
    public static class TerminalFactory {
        ...
        public static NumberLiteral CreateCSharpNumber(string name) {
            var term = new NumberLiteral(name, NumberOptions.AllowLetterAfter);
            term.DefaultIntTypes.AddRange(TypeCode.Int32, TypeCode.UInt32, TypeCode.Int64, TypeCode.UInt64);
        ...
        public static NumberLiteral CreateVbNumber(string name) {
            ...
            term.DefaultIntTypes.AddRange(TypeCode.Int32, TypeCode.Int64);
        ...
        public static NumberLiteral CreatePythonNumber(string name) {
            ...
            term.DefaultIntTypes.AddRange(TypeCode.Int32, TypeCode.Int64, NumberLiteral.TypeCodeBigInt);
            // term.DefaultFloatType = TypeCode.Double; -- it is default
        ...
        public static IdentifierTerminal CreatePythonIdentifier(string name) {
            var id = new IdentifierTerminal("Identifier"); //defaults are OK
            return id;
        }
