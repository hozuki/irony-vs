...
namespace Irony.Parsing {
    ...
    */
    public sealed class ParseTreeNode {
        ...
        public object AstNode { get; internal set; }
        ...
        private static Token FindFirstChildTokenRec(ParseTreeNode node) {
            ...
            foreach (var child in node.ChildNodes) {
                var token = FindFirstChildTokenRec(child);
                if (token != null) {
                    return token;
                }
            }
        ...
        public bool IsOperator => Term.Flags.IsSet(TermFlags.IsOperator);
