...
namespace Irony.Utilities {
    ...
    public static class ParserDataPrinter {
        ...
        public static string PrintStateList(this LanguageData language) {
        ...
        public static string PrintTerminals(LanguageData language) {
            ...
            termList.Sort((x, y) => string.CompareOrdinal(x.Name, y.Name));
        ...
        public static string PrintNonTerminals(LanguageData language) {
            ...
            ntList.Sort((x, y) => string.CompareOrdinal(x.Name, y.Name));
