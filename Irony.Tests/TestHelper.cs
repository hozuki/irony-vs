...
namespace Irony.Tests {
    ...
    public static class TestHelper {
        ...
        private sealed class TerminalTestGrammar : Grammar {
        ...
        public static Token ParseInput(this Parser parser, string input) {
            return ParseInput(parser, input, true);
        }

        public static Token ParseInput(this Parser parser, string input, bool useTerminator) {
