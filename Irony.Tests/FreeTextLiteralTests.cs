...
namespace Irony.Tests {
    ...
    [TestClass]
    public sealed class FreeTextLiteralTests {

        //A special grammar that does not skip whitespace
        private sealed class FreeTextLiteralTestGrammar : Grammar {
        ...
        public void TestFreeTextLiteral_Escapes() {
            ...
            var parser = CreateParser(term);
            var token = GetFirst(parser.Parse(@"abc\\de\,\)fg,"));
