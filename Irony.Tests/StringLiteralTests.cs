...
namespace Irony.Tests {
    ...
    public sealed class StringLiteralTests {
        ...
        public void TestString_QuoteJustBeforeEof() {
            var parser = TestHelper.CreateParser(new StringLiteral("String", "'"));
        ...
        public void TestString_Python() {
            var parser = TestHelper.CreateParser(TerminalFactory.CreatePythonString("String"));
            //1. Single quotes
            var token = parser.ParseInput(@"'00\a\b\t\n\v\f\r\'\\00'  ");
        ...
        public void TestString_CSharp() {
            var parser = TestHelper.CreateParser(TerminalFactory.CreateCSharpString("String"));

            var token = parser.ParseInput('"' + @"abcd\\" + '"' + "  ");
