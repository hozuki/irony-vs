...
namespace Irony.Interpreter {
    ...
    public class ScopeValuesDictionary : IDictionary<string, object> {
        ...
        public void Add(string key, object value) {
            var slot = _scope.Info.GetSlot(key) ?? _scope.AddSlot(key);
        ...
        public ICollection<string> Keys => _scope.Info.GetNames();
        ...
        public ICollection<object> Values => _scope.GetValues();
        ...
        public int Count => _scope.Info.GetSlotCount();
