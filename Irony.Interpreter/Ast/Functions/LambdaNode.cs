...
namespace Irony.Interpreter.Ast {
    ...
    public sealed class LambdaNode : AstNode {
        ...
        internal LambdaNode(AstContext context, ParseTreeNode node, ParseTreeNode parameters, ParseTreeNode body) {
        ...
        public override void Initialize(AstContext context, ParseTreeNode parseNode) {
        ...
        private void InitImpl(AstContext context, ParseTreeNode parseNode, ParseTreeNode parametersNode, ParseTreeNode bodyNode) {
            base.Initialize(context, parseNode);
